...
local localizations = {
    ...
    ["ruRU"] = {
        ...
        ["COMMAND_HELP"] = "Введите %s для справки.",
        
        -- Messages
        ["SCAN_IN_PROGRESS"] = "Сканирование уже выполняется.",
        ["AH_CLOSED"] = "Для начала сканирования аукцион должен быть открыт.",
        ["SCAN_STARTED"] = "Запуск автоматического сканирования...",
        ["SCAN_MANUAL_STARTED"] = "Запуск текущего сканирования...",
        ...
        ["ADDON_DESCRIPTION"] = "MiniAHScanner — это легковесный аддон для сканирования аукциона и отображения цен в подсказках. Он разработан для простоты и эффективности, с соблюдением 15-минутного лимита для предотвращения отключения от сервера.",
        ...
        ["AUTO_SCAN_TOOLTIP"] = "Включает автоматическое сканирование аукциона при его открытии.",
        ...
        ["PLAY_SCAN_COMPLETE_SOUND_TOOLTIP"] = "Проигрывает звук по завершении сканирования аукциона.",
        ...
        ["HISTORY_DAYS"] = "Дней истории для сохранения",
        ["HISTORY_DAYS_TOOLTIP"] = "Количество дней для сохранения истории.",
        ["CLEAN_OLD_DATA"] = "Удалять старые данные (дни)",
        ...
        ["SHOW_VENDOR_PRICE"] = "Показывать цены у торговцев в подсказках",
        ["SHOW_VENDOR_PRICE_TOOLTIP"] = "Отображает цены у торговцев в подсказках предметов.",
